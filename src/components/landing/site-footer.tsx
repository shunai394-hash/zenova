...
export function SiteFooter() {
  return (
    <footer className="border-t border-zinc-800 bg-zinc-950">
      <div className="mx-auto grid max-w-5xl gap-10 px-4 py-14 sm:px-6 sm:py-16 md:grid-cols-3">
        <div>
      ...
      <div className="border-t border-zinc-800 px-4 py-5 sm:px-6">
        <p className="mx-auto max-w-5xl text-center text-xs text-gray-600">
          {FOOTER_COPYRIGHT}
        </p>
      </div>
    </footer>
